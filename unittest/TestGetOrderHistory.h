...
TEST(TestGetOrderHistory, result) {
    ...
    ASSERT_EQ(1550630155568l, orders[0].canceledTimestamp);
    ASSERT_EQ(1550630155647l, orders[0].finishedTimestamp);
    ASSERT_EQ(1550630155350l, orders[0].createdTimestamp);
