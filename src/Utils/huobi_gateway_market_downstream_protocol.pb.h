...
#ifndef PROTOBUF_INCLUDED_huobi_5fgateway_5fmarket_5fdownstream_5fprotocol_2eproto
#define PROTOBUF_INCLUDED_huobi_5fgateway_5fmarket_5fdownstream_5fprotocol_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_huobi_5fgateway_5fmarket_5fdownstream_5fprotocol_2eproto 
...
namespace google {
namespace protobuf {
template<> ::com::huobi::gateway::AggrTrade* Arena::CreateMaybeMessage<::com::huobi::gateway::AggrTrade>(Arena*);
template<> ::com::huobi::gateway::Candlestick* Arena::CreateMaybeMessage<::com::huobi::gateway::Candlestick>(Arena*);
template<> ::com::huobi::gateway::Depth* Arena::CreateMaybeMessage<::com::huobi::gateway::Depth>(Arena*);
template<> ::com::huobi::gateway::Depth_Tick* Arena::CreateMaybeMessage<::com::huobi::gateway::Depth_Tick>(Arena*);
template<> ::com::huobi::gateway::MarketSummary* Arena::CreateMaybeMessage<::com::huobi::gateway::MarketSummary>(Arena*);
template<> ::com::huobi::gateway::Overview* Arena::CreateMaybeMessage<::com::huobi::gateway::Overview>(Arena*);
template<> ::com::huobi::gateway::Overview_Tick* Arena::CreateMaybeMessage<::com::huobi::gateway::Overview_Tick>(Arena*);
template<> ::com::huobi::gateway::Ping* Arena::CreateMaybeMessage<::com::huobi::gateway::Ping>(Arena*);
template<> ::com::huobi::gateway::ReqCandlestick* Arena::CreateMaybeMessage<::com::huobi::gateway::ReqCandlestick>(Arena*);
template<> ::com::huobi::gateway::ReqCandlestick_Tick* Arena::CreateMaybeMessage<::com::huobi::gateway::ReqCandlestick_Tick>(Arena*);
template<> ::com::huobi::gateway::ReqTrade* Arena::CreateMaybeMessage<::com::huobi::gateway::ReqTrade>(Arena*);
template<> ::com::huobi::gateway::ReqTrade_Tick* Arena::CreateMaybeMessage<::com::huobi::gateway::ReqTrade_Tick>(Arena*);
template<> ::com::huobi::gateway::Result* Arena::CreateMaybeMessage<::com::huobi::gateway::Result>(Arena*);
template<> ::com::huobi::gateway::Trade* Arena::CreateMaybeMessage<::com::huobi::gateway::Trade>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace com {
namespace huobi {
...
class Candlestick : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.huobi.gateway.Candlestick) */ {
 public:
  Candlestick();
  virtual ~Candlestick();
 ...
 private:
  ...
  friend struct ::protobuf_huobi_5fgateway_5fmarket_5fdownstream_5fprotocol_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class ReqCandlestick_Tick : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.huobi.gateway.ReqCandlestick.Tick) */ {
 public:
  ReqCandlestick_Tick();
...
class ReqCandlestick : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.huobi.gateway.ReqCandlestick) */ {
 public:
  ReqCandlestick();
  ...
  ::com::huobi::gateway::ReqCandlestick_Tick* mutable_candlesticks(int index);
  ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::ReqCandlestick_Tick >*
      mutable_candlesticks();
  const ::com::huobi::gateway::ReqCandlestick_Tick& candlesticks(int index) const;
  ::com::huobi::gateway::ReqCandlestick_Tick* add_candlesticks();
  const ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::ReqCandlestick_Tick >&
      candlesticks() const;
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::ReqCandlestick_Tick > candlesticks_;
  ::google::protobuf::internal::ArenaStringPtr symbol_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_huobi_5fgateway_5fmarket_5fdownstream_5fprotocol_2eproto::TableStruct;
};
...
class Depth_Tick : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.huobi.gateway.Depth.Tick) */ {
 public:
  Depth_Tick();
  virtual ~Depth_Tick();
...
class Depth : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.huobi.gateway.Depth) */ {
 public:
  Depth();
  virtual ~Depth();
  ...
  ::com::huobi::gateway::Depth_Tick* mutable_bids(int index);
  ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::Depth_Tick >*
      mutable_bids();
  const ::com::huobi::gateway::Depth_Tick& bids(int index) const;
  ::com::huobi::gateway::Depth_Tick* add_bids();
  const ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::Depth_Tick >&
      bids() const;
  ...
  ::com::huobi::gateway::Depth_Tick* mutable_asks(int index);
  ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::Depth_Tick >*
      mutable_asks();
  const ::com::huobi::gateway::Depth_Tick& asks(int index) const;
  ::com::huobi::gateway::Depth_Tick* add_asks();
  const ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::Depth_Tick >&
      asks() const;
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::Depth_Tick > bids_;
  ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::Depth_Tick > asks_;
  ::google::protobuf::internal::ArenaStringPtr symbol_;
  ::google::protobuf::int64 ts_;
  bool delta_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
...
class AggrTrade : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.huobi.gateway.AggrTrade) */ {
 public:
  AggrTrade();
  virtual ~AggrTrade();
  ...
  ::com::huobi::gateway::Side side() const;
  void set_side(::com::huobi::gateway::Side value);
...
class Trade : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.huobi.gateway.Trade) */ {
 public:
  Trade();
  virtual ~Trade();
...
class ReqTrade_Tick : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.huobi.gateway.ReqTrade.Tick) */ {
 public:
  ReqTrade_Tick();
...
class ReqTrade : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.huobi.gateway.ReqTrade) */ {
 public:
  ReqTrade();
  virtual ~ReqTrade();
  ...
  ::com::huobi::gateway::ReqTrade_Tick* mutable_trades(int index);
  ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::ReqTrade_Tick >*
      mutable_trades();
  const ::com::huobi::gateway::ReqTrade_Tick& trades(int index) const;
  ::com::huobi::gateway::ReqTrade_Tick* add_trades();
  const ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::ReqTrade_Tick >&
      trades() const;
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::ReqTrade_Tick > trades_;
  ::google::protobuf::internal::ArenaStringPtr symbol_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_huobi_5fgateway_5fmarket_5fdownstream_5fprotocol_2eproto::TableStruct;
};
...
class MarketSummary : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.huobi.gateway.MarketSummary) */ {
 public:
  MarketSummary();
...
class Overview_Tick : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.huobi.gateway.Overview.Tick) */ {
 public:
  Overview_Tick();
...
class Overview : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.huobi.gateway.Overview) */ {
 public:
  Overview();
  virtual ~Overview();
  ...
  ::com::huobi::gateway::Overview_Tick* mutable_tick(int index);
  ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::Overview_Tick >*
      mutable_tick();
  const ::com::huobi::gateway::Overview_Tick& tick(int index) const;
  ::com::huobi::gateway::Overview_Tick* add_tick();
  const ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::Overview_Tick >&
      tick() const;
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::Overview_Tick > tick_;
  ::google::protobuf::int64 ts_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_huobi_5fgateway_5fmarket_5fdownstream_5fprotocol_2eproto::TableStruct;
};
...
class Ping : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.huobi.gateway.Ping) */ {
 public:
  Ping();
  virtual ~Ping();
...
class Result : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.huobi.gateway.Result) */ {
 public:
  Result();
  virtual ~Result();
  ...
  ::com::huobi::gateway::Action action() const;
  void set_action(::com::huobi::gateway::Action value);
...
inline ::google::protobuf::int64 Candlestick::ts() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Candlestick.ts)
  return ts_;
}
inline void Candlestick::set_ts(::google::protobuf::int64 value) {
  
  ts_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Candlestick.ts)
}
...
inline ::google::protobuf::int64 Candlestick::id() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Candlestick.id)
  return id_;
}
inline void Candlestick::set_id(::google::protobuf::int64 value) {
  
  id_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Candlestick.id)
}
...
inline const ::std::string& Candlestick::open() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Candlestick.open)
...
inline void Candlestick::set_open(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Candlestick.open)
}
#if LANG_CXX11
inline void Candlestick::set_open(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Candlestick.open)
}
#endif
inline void Candlestick::set_open(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Candlestick.open)
}
inline void Candlestick::set_open(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Candlestick.open)
}
inline ::std::string* Candlestick::mutable_open() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Candlestick.open)
...
inline ::std::string* Candlestick::release_open() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Candlestick.open)
...
inline void Candlestick::set_allocated_open(::std::string* open) {
  ...
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Candlestick.open)
}
...
inline const ::std::string& Candlestick::close() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Candlestick.close)
...
inline void Candlestick::set_close(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Candlestick.close)
}
#if LANG_CXX11
inline void Candlestick::set_close(::std::string&& value) {
  ...
  close_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Candlestick.close)
}
#endif
inline void Candlestick::set_close(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Candlestick.close)
}
inline void Candlestick::set_close(const char* value, size_t size) {
  ...
  close_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Candlestick.close)
}
inline ::std::string* Candlestick::mutable_close() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Candlestick.close)
...
inline ::std::string* Candlestick::release_close() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Candlestick.close)
...
inline void Candlestick::set_allocated_close(::std::string* close) {
  ...
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Candlestick.close)
}
...
inline const ::std::string& Candlestick::low() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Candlestick.low)
...
inline void Candlestick::set_low(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Candlestick.low)
}
#if LANG_CXX11
inline void Candlestick::set_low(::std::string&& value) {
  ...
  low_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Candlestick.low)
}
#endif
inline void Candlestick::set_low(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Candlestick.low)
}
inline void Candlestick::set_low(const char* value, size_t size) {
  ...
  low_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Candlestick.low)
}
inline ::std::string* Candlestick::mutable_low() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Candlestick.low)
  return low_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Candlestick::release_low() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Candlestick.low)
...
inline void Candlestick::set_allocated_low(::std::string* low) {
  ...
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Candlestick.low)
}
...
inline const ::std::string& Candlestick::high() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Candlestick.high)
...
inline void Candlestick::set_high(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Candlestick.high)
}
#if LANG_CXX11
inline void Candlestick::set_high(::std::string&& value) {
  ...
  high_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Candlestick.high)
}
#endif
inline void Candlestick::set_high(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Candlestick.high)
}
inline void Candlestick::set_high(const char* value, size_t size) {
  ...
  high_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Candlestick.high)
}
inline ::std::string* Candlestick::mutable_high() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Candlestick.high)
...
inline ::std::string* Candlestick::release_high() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Candlestick.high)
...
inline void Candlestick::set_allocated_high(::std::string* high) {
  ...
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Candlestick.high)
}
...
inline const ::std::string& Candlestick::turnover() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Candlestick.turnover)
...
inline void Candlestick::set_turnover(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Candlestick.turnover)
}
#if LANG_CXX11
inline void Candlestick::set_turnover(::std::string&& value) {
  ...
  turnover_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Candlestick.turnover)
}
#endif
inline void Candlestick::set_turnover(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Candlestick.turnover)
}
inline void Candlestick::set_turnover(const char* value, size_t size) {
  ...
  turnover_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Candlestick.turnover)
}
inline ::std::string* Candlestick::mutable_turnover() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Candlestick.turnover)
...
inline ::std::string* Candlestick::release_turnover() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Candlestick.turnover)
...
inline void Candlestick::set_allocated_turnover(::std::string* turnover) {
  ...
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Candlestick.turnover)
}
...
inline const ::std::string& Candlestick::volume() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Candlestick.volume)
...
inline void Candlestick::set_volume(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Candlestick.volume)
}
#if LANG_CXX11
inline void Candlestick::set_volume(::std::string&& value) {
  ...
  volume_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Candlestick.volume)
}
#endif
inline void Candlestick::set_volume(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Candlestick.volume)
}
inline void Candlestick::set_volume(const char* value, size_t size) {
  ...
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Candlestick.volume)
}
inline ::std::string* Candlestick::mutable_volume() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Candlestick.volume)
...
inline ::std::string* Candlestick::release_volume() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Candlestick.volume)
...
inline void Candlestick::set_allocated_volume(::std::string* volume) {
  ...
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Candlestick.volume)
}
...
inline ::google::protobuf::int32 Candlestick::num_of_trades() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Candlestick.num_of_trades)
  return num_of_trades_;
}
inline void Candlestick::set_num_of_trades(::google::protobuf::int32 value) {
  
  num_of_trades_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Candlestick.num_of_trades)
}
...
inline const ::std::string& Candlestick::symbol() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Candlestick.symbol)
  return symbol_.GetNoArena();
}
inline void Candlestick::set_symbol(const ::std::string& value) {
  
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Candlestick.symbol)
}
#if LANG_CXX11
inline void Candlestick::set_symbol(::std::string&& value) {
  ...
  symbol_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Candlestick.symbol)
}
#endif
inline void Candlestick::set_symbol(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Candlestick.symbol)
}
inline void Candlestick::set_symbol(const char* value, size_t size) {
  
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Candlestick.symbol)
}
inline ::std::string* Candlestick::mutable_symbol() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Candlestick.symbol)
  return symbol_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Candlestick::release_symbol() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Candlestick.symbol)
...
inline void Candlestick::set_allocated_symbol(::std::string* symbol) {
  ...
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Candlestick.symbol)
}
...
inline ::google::protobuf::int64 ReqCandlestick_Tick::ts() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqCandlestick.Tick.ts)
  return ts_;
}
inline void ReqCandlestick_Tick::set_ts(::google::protobuf::int64 value) {
  
  ts_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.ReqCandlestick.Tick.ts)
}
...
inline ::google::protobuf::int64 ReqCandlestick_Tick::id() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqCandlestick.Tick.id)
  return id_;
}
inline void ReqCandlestick_Tick::set_id(::google::protobuf::int64 value) {
  
  id_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.ReqCandlestick.Tick.id)
}
...
inline const ::std::string& ReqCandlestick_Tick::open() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqCandlestick.Tick.open)
  return open_.GetNoArena();
}
inline void ReqCandlestick_Tick::set_open(const ::std::string& value) {
  
  open_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.ReqCandlestick.Tick.open)
}
#if LANG_CXX11
inline void ReqCandlestick_Tick::set_open(::std::string&& value) {
  ...
  open_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.ReqCandlestick.Tick.open)
}
#endif
inline void ReqCandlestick_Tick::set_open(const char* value) {
  ...
  open_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.ReqCandlestick.Tick.open)
}
inline void ReqCandlestick_Tick::set_open(const char* value, size_t size) {
  
  open_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.ReqCandlestick.Tick.open)
}
inline ::std::string* ReqCandlestick_Tick::mutable_open() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.ReqCandlestick.Tick.open)
  return open_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ReqCandlestick_Tick::release_open() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.ReqCandlestick.Tick.open)
...
inline void ReqCandlestick_Tick::set_allocated_open(::std::string* open) {
  ...
  open_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), open);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.ReqCandlestick.Tick.open)
}
...
inline const ::std::string& ReqCandlestick_Tick::close() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqCandlestick.Tick.close)
  return close_.GetNoArena();
}
inline void ReqCandlestick_Tick::set_close(const ::std::string& value) {
  
  close_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.ReqCandlestick.Tick.close)
}
#if LANG_CXX11
inline void ReqCandlestick_Tick::set_close(::std::string&& value) {
  ...
  close_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.ReqCandlestick.Tick.close)
}
#endif
inline void ReqCandlestick_Tick::set_close(const char* value) {
  ...
  close_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.ReqCandlestick.Tick.close)
}
inline void ReqCandlestick_Tick::set_close(const char* value, size_t size) {
  
  close_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.ReqCandlestick.Tick.close)
}
inline ::std::string* ReqCandlestick_Tick::mutable_close() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.ReqCandlestick.Tick.close)
  return close_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ReqCandlestick_Tick::release_close() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.ReqCandlestick.Tick.close)
...
inline void ReqCandlestick_Tick::set_allocated_close(::std::string* close) {
  ...
  close_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), close);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.ReqCandlestick.Tick.close)
}
...
inline const ::std::string& ReqCandlestick_Tick::low() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqCandlestick.Tick.low)
  return low_.GetNoArena();
}
inline void ReqCandlestick_Tick::set_low(const ::std::string& value) {
  
  low_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.ReqCandlestick.Tick.low)
}
#if LANG_CXX11
inline void ReqCandlestick_Tick::set_low(::std::string&& value) {
  ...
  low_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.ReqCandlestick.Tick.low)
}
#endif
inline void ReqCandlestick_Tick::set_low(const char* value) {
  ...
  low_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.ReqCandlestick.Tick.low)
}
inline void ReqCandlestick_Tick::set_low(const char* value, size_t size) {
  
  low_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.ReqCandlestick.Tick.low)
}
inline ::std::string* ReqCandlestick_Tick::mutable_low() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.ReqCandlestick.Tick.low)
  return low_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ReqCandlestick_Tick::release_low() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.ReqCandlestick.Tick.low)
...
inline void ReqCandlestick_Tick::set_allocated_low(::std::string* low) {
  ...
  low_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), low);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.ReqCandlestick.Tick.low)
}
...
inline const ::std::string& ReqCandlestick_Tick::high() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqCandlestick.Tick.high)
  return high_.GetNoArena();
}
inline void ReqCandlestick_Tick::set_high(const ::std::string& value) {
  
  high_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.ReqCandlestick.Tick.high)
}
#if LANG_CXX11
inline void ReqCandlestick_Tick::set_high(::std::string&& value) {
  ...
  high_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.ReqCandlestick.Tick.high)
}
#endif
inline void ReqCandlestick_Tick::set_high(const char* value) {
  ...
  high_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.ReqCandlestick.Tick.high)
}
inline void ReqCandlestick_Tick::set_high(const char* value, size_t size) {
  
  high_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.ReqCandlestick.Tick.high)
}
inline ::std::string* ReqCandlestick_Tick::mutable_high() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.ReqCandlestick.Tick.high)
  return high_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ReqCandlestick_Tick::release_high() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.ReqCandlestick.Tick.high)
...
inline void ReqCandlestick_Tick::set_allocated_high(::std::string* high) {
  ...
  high_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), high);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.ReqCandlestick.Tick.high)
}
...
inline const ::std::string& ReqCandlestick_Tick::turnover() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqCandlestick.Tick.turnover)
  return turnover_.GetNoArena();
}
inline void ReqCandlestick_Tick::set_turnover(const ::std::string& value) {
  
  turnover_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.ReqCandlestick.Tick.turnover)
}
#if LANG_CXX11
inline void ReqCandlestick_Tick::set_turnover(::std::string&& value) {
  ...
  turnover_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.ReqCandlestick.Tick.turnover)
}
#endif
inline void ReqCandlestick_Tick::set_turnover(const char* value) {
  ...
  turnover_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.ReqCandlestick.Tick.turnover)
}
inline void ReqCandlestick_Tick::set_turnover(const char* value, size_t size) {
  
  turnover_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.ReqCandlestick.Tick.turnover)
}
inline ::std::string* ReqCandlestick_Tick::mutable_turnover() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.ReqCandlestick.Tick.turnover)
  return turnover_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ReqCandlestick_Tick::release_turnover() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.ReqCandlestick.Tick.turnover)
...
inline void ReqCandlestick_Tick::set_allocated_turnover(::std::string* turnover) {
  ...
  turnover_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), turnover);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.ReqCandlestick.Tick.turnover)
}
...
inline const ::std::string& ReqCandlestick_Tick::volume() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqCandlestick.Tick.volume)
  return volume_.GetNoArena();
}
inline void ReqCandlestick_Tick::set_volume(const ::std::string& value) {
  
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.ReqCandlestick.Tick.volume)
}
#if LANG_CXX11
inline void ReqCandlestick_Tick::set_volume(::std::string&& value) {
  ...
  volume_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.ReqCandlestick.Tick.volume)
}
#endif
inline void ReqCandlestick_Tick::set_volume(const char* value) {
  ...
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.ReqCandlestick.Tick.volume)
}
inline void ReqCandlestick_Tick::set_volume(const char* value, size_t size) {
  
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.ReqCandlestick.Tick.volume)
}
inline ::std::string* ReqCandlestick_Tick::mutable_volume() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.ReqCandlestick.Tick.volume)
  return volume_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ReqCandlestick_Tick::release_volume() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.ReqCandlestick.Tick.volume)
...
inline void ReqCandlestick_Tick::set_allocated_volume(::std::string* volume) {
  ...
  volume_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), volume);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.ReqCandlestick.Tick.volume)
}
...
inline ::google::protobuf::int32 ReqCandlestick_Tick::num_of_trades() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqCandlestick.Tick.num_of_trades)
  return num_of_trades_;
}
inline void ReqCandlestick_Tick::set_num_of_trades(::google::protobuf::int32 value) {
  
  num_of_trades_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.ReqCandlestick.Tick.num_of_trades)
}
...
inline const ::std::string& ReqCandlestick::symbol() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqCandlestick.symbol)
  return symbol_.GetNoArena();
}
inline void ReqCandlestick::set_symbol(const ::std::string& value) {
  
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.ReqCandlestick.symbol)
}
#if LANG_CXX11
inline void ReqCandlestick::set_symbol(::std::string&& value) {
  ...
  symbol_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.ReqCandlestick.symbol)
}
#endif
inline void ReqCandlestick::set_symbol(const char* value) {
  ...
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.ReqCandlestick.symbol)
}
inline void ReqCandlestick::set_symbol(const char* value, size_t size) {
  
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.ReqCandlestick.symbol)
}
inline ::std::string* ReqCandlestick::mutable_symbol() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.ReqCandlestick.symbol)
  return symbol_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ReqCandlestick::release_symbol() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.ReqCandlestick.symbol)
...
inline void ReqCandlestick::set_allocated_symbol(::std::string* symbol) {
  ...
  symbol_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), symbol);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.ReqCandlestick.symbol)
}
...
inline ::com::huobi::gateway::ReqCandlestick_Tick* ReqCandlestick::mutable_candlesticks(int index) {
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.ReqCandlestick.candlesticks)
  return candlesticks_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::ReqCandlestick_Tick >*
ReqCandlestick::mutable_candlesticks() {
  // @@protoc_insertion_point(field_mutable_list:com.huobi.gateway.ReqCandlestick.candlesticks)
  return &candlesticks_;
}
inline const ::com::huobi::gateway::ReqCandlestick_Tick& ReqCandlestick::candlesticks(int index) const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqCandlestick.candlesticks)
  return candlesticks_.Get(index);
}
inline ::com::huobi::gateway::ReqCandlestick_Tick* ReqCandlestick::add_candlesticks() {
  // @@protoc_insertion_point(field_add:com.huobi.gateway.ReqCandlestick.candlesticks)
  return candlesticks_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::ReqCandlestick_Tick >&
ReqCandlestick::candlesticks() const {
  // @@protoc_insertion_point(field_list:com.huobi.gateway.ReqCandlestick.candlesticks)
  return candlesticks_;
}
...
inline const ::std::string& Depth_Tick::price() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Depth.Tick.price)
...
inline void Depth_Tick::set_price(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Depth.Tick.price)
}
#if LANG_CXX11
inline void Depth_Tick::set_price(::std::string&& value) {
  ...
  price_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Depth.Tick.price)
}
#endif
inline void Depth_Tick::set_price(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Depth.Tick.price)
}
inline void Depth_Tick::set_price(const char* value, size_t size) {
  ...
  price_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Depth.Tick.price)
}
inline ::std::string* Depth_Tick::mutable_price() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Depth.Tick.price)
...
inline ::std::string* Depth_Tick::release_price() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Depth.Tick.price)
...
inline void Depth_Tick::set_allocated_price(::std::string* price) {
  ...
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Depth.Tick.price)
}
...
inline const ::std::string& Depth_Tick::size() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Depth.Tick.size)
...
inline void Depth_Tick::set_size(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Depth.Tick.size)
}
#if LANG_CXX11
inline void Depth_Tick::set_size(::std::string&& value) {
  ...
  size_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Depth.Tick.size)
}
#endif
inline void Depth_Tick::set_size(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Depth.Tick.size)
}
inline void Depth_Tick::set_size(const char* value, size_t size) {
  ...
  size_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Depth.Tick.size)
}
inline ::std::string* Depth_Tick::mutable_size() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Depth.Tick.size)
...
inline ::std::string* Depth_Tick::release_size() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Depth.Tick.size)
...
inline void Depth_Tick::set_allocated_size(::std::string* size) {
  ...
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Depth.Tick.size)
}
...
inline ::google::protobuf::int64 Depth::ts() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Depth.ts)
  return ts_;
}
inline void Depth::set_ts(::google::protobuf::int64 value) {
  
  ts_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Depth.ts)
}
...
inline ::com::huobi::gateway::Depth_Tick* Depth::mutable_bids(int index) {
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Depth.bids)
  return bids_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::Depth_Tick >*
Depth::mutable_bids() {
  // @@protoc_insertion_point(field_mutable_list:com.huobi.gateway.Depth.bids)
  return &bids_;
}
inline const ::com::huobi::gateway::Depth_Tick& Depth::bids(int index) const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Depth.bids)
  return bids_.Get(index);
}
inline ::com::huobi::gateway::Depth_Tick* Depth::add_bids() {
  // @@protoc_insertion_point(field_add:com.huobi.gateway.Depth.bids)
  return bids_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::Depth_Tick >&
Depth::bids() const {
  // @@protoc_insertion_point(field_list:com.huobi.gateway.Depth.bids)
  return bids_;
}
...
inline ::com::huobi::gateway::Depth_Tick* Depth::mutable_asks(int index) {
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Depth.asks)
  return asks_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::Depth_Tick >*
Depth::mutable_asks() {
  // @@protoc_insertion_point(field_mutable_list:com.huobi.gateway.Depth.asks)
  return &asks_;
}
inline const ::com::huobi::gateway::Depth_Tick& Depth::asks(int index) const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Depth.asks)
  return asks_.Get(index);
}
inline ::com::huobi::gateway::Depth_Tick* Depth::add_asks() {
  // @@protoc_insertion_point(field_add:com.huobi.gateway.Depth.asks)
  return asks_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::Depth_Tick >&
Depth::asks() const {
  // @@protoc_insertion_point(field_list:com.huobi.gateway.Depth.asks)
  return asks_;
}
...
inline bool Depth::delta() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Depth.delta)
  return delta_;
}
inline void Depth::set_delta(bool value) {
  
  delta_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Depth.delta)
}
...
inline const ::std::string& Depth::symbol() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Depth.symbol)
  return symbol_.GetNoArena();
}
inline void Depth::set_symbol(const ::std::string& value) {
  
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Depth.symbol)
}
#if LANG_CXX11
inline void Depth::set_symbol(::std::string&& value) {
  ...
  symbol_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Depth.symbol)
}
#endif
inline void Depth::set_symbol(const char* value) {
  ...
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Depth.symbol)
}
inline void Depth::set_symbol(const char* value, size_t size) {
  
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Depth.symbol)
}
inline ::std::string* Depth::mutable_symbol() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Depth.symbol)
  return symbol_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Depth::release_symbol() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Depth.symbol)
...
inline void Depth::set_allocated_symbol(::std::string* symbol) {
  ...
  symbol_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), symbol);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Depth.symbol)
}
...
inline ::google::protobuf::int64 AggrTrade::first_trade_id() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.AggrTrade.first_trade_id)
  return first_trade_id_;
}
inline void AggrTrade::set_first_trade_id(::google::protobuf::int64 value) {
  
  first_trade_id_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.AggrTrade.first_trade_id)
}
...
inline ::google::protobuf::int64 AggrTrade::last_trade_id() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.AggrTrade.last_trade_id)
  return last_trade_id_;
}
inline void AggrTrade::set_last_trade_id(::google::protobuf::int64 value) {
  
  last_trade_id_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.AggrTrade.last_trade_id)
}
...
inline ::google::protobuf::int64 AggrTrade::ts() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.AggrTrade.ts)
  return ts_;
}
inline void AggrTrade::set_ts(::google::protobuf::int64 value) {
  
  ts_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.AggrTrade.ts)
}
...
inline const ::std::string& AggrTrade::price() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.AggrTrade.price)
  return price_.GetNoArena();
}
inline void AggrTrade::set_price(const ::std::string& value) {
  
  price_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.AggrTrade.price)
}
#if LANG_CXX11
inline void AggrTrade::set_price(::std::string&& value) {
  ...
  price_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.AggrTrade.price)
}
#endif
inline void AggrTrade::set_price(const char* value) {
  ...
  price_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.AggrTrade.price)
}
inline void AggrTrade::set_price(const char* value, size_t size) {
  
  price_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.AggrTrade.price)
}
inline ::std::string* AggrTrade::mutable_price() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.AggrTrade.price)
  return price_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* AggrTrade::release_price() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.AggrTrade.price)
...
inline void AggrTrade::set_allocated_price(::std::string* price) {
  ...
  price_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), price);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.AggrTrade.price)
}
...
inline const ::std::string& AggrTrade::volume() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.AggrTrade.volume)
  return volume_.GetNoArena();
}
inline void AggrTrade::set_volume(const ::std::string& value) {
  
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.AggrTrade.volume)
}
#if LANG_CXX11
inline void AggrTrade::set_volume(::std::string&& value) {
  ...
  volume_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.AggrTrade.volume)
}
#endif
inline void AggrTrade::set_volume(const char* value) {
  ...
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.AggrTrade.volume)
}
inline void AggrTrade::set_volume(const char* value, size_t size) {
  
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.AggrTrade.volume)
}
inline ::std::string* AggrTrade::mutable_volume() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.AggrTrade.volume)
  return volume_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* AggrTrade::release_volume() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.AggrTrade.volume)
...
inline void AggrTrade::set_allocated_volume(::std::string* volume) {
  ...
  volume_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), volume);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.AggrTrade.volume)
}
...
inline ::com::huobi::gateway::Side AggrTrade::side() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.AggrTrade.side)
  return static_cast< ::com::huobi::gateway::Side >(side_);
}
inline void AggrTrade::set_side(::com::huobi::gateway::Side value) {
  
  side_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.AggrTrade.side)
}
...
inline const ::std::string& AggrTrade::symbol() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.AggrTrade.symbol)
  return symbol_.GetNoArena();
}
inline void AggrTrade::set_symbol(const ::std::string& value) {
  
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.AggrTrade.symbol)
}
#if LANG_CXX11
inline void AggrTrade::set_symbol(::std::string&& value) {
  ...
  symbol_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.AggrTrade.symbol)
}
#endif
inline void AggrTrade::set_symbol(const char* value) {
  ...
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.AggrTrade.symbol)
}
inline void AggrTrade::set_symbol(const char* value, size_t size) {
  
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.AggrTrade.symbol)
}
inline ::std::string* AggrTrade::mutable_symbol() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.AggrTrade.symbol)
  return symbol_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* AggrTrade::release_symbol() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.AggrTrade.symbol)
...
inline void AggrTrade::set_allocated_symbol(::std::string* symbol) {
  ...
  symbol_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), symbol);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.AggrTrade.symbol)
}
...
inline ::google::protobuf::int64 Trade::trade_id() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Trade.trade_id)
  return trade_id_;
}
inline void Trade::set_trade_id(::google::protobuf::int64 value) {
  
  trade_id_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Trade.trade_id)
}
...
inline ::google::protobuf::int64 Trade::ts() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Trade.ts)
  return ts_;
}
inline void Trade::set_ts(::google::protobuf::int64 value) {
  
  ts_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Trade.ts)
}
...
inline const ::std::string& Trade::price() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Trade.price)
  return price_.GetNoArena();
}
inline void Trade::set_price(const ::std::string& value) {
  
  price_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Trade.price)
}
#if LANG_CXX11
inline void Trade::set_price(::std::string&& value) {
  ...
  price_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Trade.price)
}
#endif
inline void Trade::set_price(const char* value) {
  ...
  price_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Trade.price)
}
inline void Trade::set_price(const char* value, size_t size) {
  
  price_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Trade.price)
}
inline ::std::string* Trade::mutable_price() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Trade.price)
  return price_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Trade::release_price() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Trade.price)
...
inline void Trade::set_allocated_price(::std::string* price) {
  ...
  price_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), price);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Trade.price)
}
...
inline const ::std::string& Trade::volume() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Trade.volume)
  return volume_.GetNoArena();
}
inline void Trade::set_volume(const ::std::string& value) {
  
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Trade.volume)
}
#if LANG_CXX11
inline void Trade::set_volume(::std::string&& value) {
  ...
  volume_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Trade.volume)
}
#endif
inline void Trade::set_volume(const char* value) {
  ...
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Trade.volume)
}
inline void Trade::set_volume(const char* value, size_t size) {
  
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Trade.volume)
}
inline ::std::string* Trade::mutable_volume() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Trade.volume)
  return volume_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Trade::release_volume() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Trade.volume)
...
inline void Trade::set_allocated_volume(::std::string* volume) {
  ...
  volume_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), volume);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Trade.volume)
}
...
inline ::com::huobi::gateway::Side Trade::side() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Trade.side)
  return static_cast< ::com::huobi::gateway::Side >(side_);
}
inline void Trade::set_side(::com::huobi::gateway::Side value) {
  
  side_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Trade.side)
}
...
inline const ::std::string& Trade::symbol() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Trade.symbol)
  return symbol_.GetNoArena();
}
inline void Trade::set_symbol(const ::std::string& value) {
  
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Trade.symbol)
}
#if LANG_CXX11
inline void Trade::set_symbol(::std::string&& value) {
  ...
  symbol_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Trade.symbol)
}
#endif
inline void Trade::set_symbol(const char* value) {
  ...
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Trade.symbol)
}
inline void Trade::set_symbol(const char* value, size_t size) {
  
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Trade.symbol)
}
inline ::std::string* Trade::mutable_symbol() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Trade.symbol)
  return symbol_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Trade::release_symbol() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Trade.symbol)
...
inline void Trade::set_allocated_symbol(::std::string* symbol) {
  ...
  symbol_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), symbol);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Trade.symbol)
}
...
inline ::google::protobuf::int64 ReqTrade_Tick::trade_id() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqTrade.Tick.trade_id)
  return trade_id_;
}
inline void ReqTrade_Tick::set_trade_id(::google::protobuf::int64 value) {
  
  trade_id_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.ReqTrade.Tick.trade_id)
}
...
inline ::google::protobuf::int64 ReqTrade_Tick::ts() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqTrade.Tick.ts)
  return ts_;
}
inline void ReqTrade_Tick::set_ts(::google::protobuf::int64 value) {
  
  ts_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.ReqTrade.Tick.ts)
}
...
inline const ::std::string& ReqTrade_Tick::price() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqTrade.Tick.price)
  return price_.GetNoArena();
}
inline void ReqTrade_Tick::set_price(const ::std::string& value) {
  
  price_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.ReqTrade.Tick.price)
}
#if LANG_CXX11
inline void ReqTrade_Tick::set_price(::std::string&& value) {
  ...
  price_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.ReqTrade.Tick.price)
}
#endif
inline void ReqTrade_Tick::set_price(const char* value) {
  ...
  price_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.ReqTrade.Tick.price)
}
inline void ReqTrade_Tick::set_price(const char* value, size_t size) {
  
  price_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.ReqTrade.Tick.price)
}
inline ::std::string* ReqTrade_Tick::mutable_price() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.ReqTrade.Tick.price)
  return price_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ReqTrade_Tick::release_price() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.ReqTrade.Tick.price)
...
inline void ReqTrade_Tick::set_allocated_price(::std::string* price) {
  ...
  price_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), price);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.ReqTrade.Tick.price)
}
...
inline const ::std::string& ReqTrade_Tick::volume() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqTrade.Tick.volume)
  return volume_.GetNoArena();
}
inline void ReqTrade_Tick::set_volume(const ::std::string& value) {
  
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.ReqTrade.Tick.volume)
}
#if LANG_CXX11
inline void ReqTrade_Tick::set_volume(::std::string&& value) {
  ...
  volume_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.ReqTrade.Tick.volume)
}
#endif
inline void ReqTrade_Tick::set_volume(const char* value) {
  ...
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.ReqTrade.Tick.volume)
}
inline void ReqTrade_Tick::set_volume(const char* value, size_t size) {
  
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.ReqTrade.Tick.volume)
}
inline ::std::string* ReqTrade_Tick::mutable_volume() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.ReqTrade.Tick.volume)
  return volume_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ReqTrade_Tick::release_volume() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.ReqTrade.Tick.volume)
...
inline void ReqTrade_Tick::set_allocated_volume(::std::string* volume) {
  ...
  volume_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), volume);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.ReqTrade.Tick.volume)
}
...
inline ::com::huobi::gateway::Side ReqTrade_Tick::side() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqTrade.Tick.side)
  return static_cast< ::com::huobi::gateway::Side >(side_);
}
inline void ReqTrade_Tick::set_side(::com::huobi::gateway::Side value) {
  
  side_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.ReqTrade.Tick.side)
}
...
inline const ::std::string& ReqTrade::symbol() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqTrade.symbol)
  return symbol_.GetNoArena();
}
inline void ReqTrade::set_symbol(const ::std::string& value) {
  
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.ReqTrade.symbol)
}
#if LANG_CXX11
inline void ReqTrade::set_symbol(::std::string&& value) {
  ...
  symbol_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.ReqTrade.symbol)
}
#endif
inline void ReqTrade::set_symbol(const char* value) {
  ...
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.ReqTrade.symbol)
}
inline void ReqTrade::set_symbol(const char* value, size_t size) {
  
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.ReqTrade.symbol)
}
inline ::std::string* ReqTrade::mutable_symbol() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.ReqTrade.symbol)
  return symbol_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ReqTrade::release_symbol() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.ReqTrade.symbol)
...
inline void ReqTrade::set_allocated_symbol(::std::string* symbol) {
  ...
  symbol_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), symbol);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.ReqTrade.symbol)
}
...
inline ::com::huobi::gateway::ReqTrade_Tick* ReqTrade::mutable_trades(int index) {
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.ReqTrade.trades)
  return trades_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::ReqTrade_Tick >*
ReqTrade::mutable_trades() {
  // @@protoc_insertion_point(field_mutable_list:com.huobi.gateway.ReqTrade.trades)
  return &trades_;
}
inline const ::com::huobi::gateway::ReqTrade_Tick& ReqTrade::trades(int index) const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.ReqTrade.trades)
  return trades_.Get(index);
}
inline ::com::huobi::gateway::ReqTrade_Tick* ReqTrade::add_trades() {
  // @@protoc_insertion_point(field_add:com.huobi.gateway.ReqTrade.trades)
  return trades_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::ReqTrade_Tick >&
ReqTrade::trades() const {
  // @@protoc_insertion_point(field_list:com.huobi.gateway.ReqTrade.trades)
  return trades_;
}
...
inline const ::std::string& MarketSummary::symbol() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.MarketSummary.symbol)
  return symbol_.GetNoArena();
}
inline void MarketSummary::set_symbol(const ::std::string& value) {
  
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.MarketSummary.symbol)
}
#if LANG_CXX11
inline void MarketSummary::set_symbol(::std::string&& value) {
  ...
  symbol_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.MarketSummary.symbol)
}
#endif
inline void MarketSummary::set_symbol(const char* value) {
  ...
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.MarketSummary.symbol)
}
inline void MarketSummary::set_symbol(const char* value, size_t size) {
  
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.MarketSummary.symbol)
}
inline ::std::string* MarketSummary::mutable_symbol() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.MarketSummary.symbol)
  return symbol_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* MarketSummary::release_symbol() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.MarketSummary.symbol)
...
inline void MarketSummary::set_allocated_symbol(::std::string* symbol) {
  ...
  symbol_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), symbol);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.MarketSummary.symbol)
}
...
inline ::google::protobuf::int64 MarketSummary::ts() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.MarketSummary.ts)
  return ts_;
}
inline void MarketSummary::set_ts(::google::protobuf::int64 value) {
  
  ts_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.MarketSummary.ts)
}
...
inline ::google::protobuf::int64 MarketSummary::id() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.MarketSummary.id)
  return id_;
}
inline void MarketSummary::set_id(::google::protobuf::int64 value) {
  
  id_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.MarketSummary.id)
}
...
inline const ::std::string& MarketSummary::open() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.MarketSummary.open)
  return open_.GetNoArena();
}
inline void MarketSummary::set_open(const ::std::string& value) {
  
  open_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.MarketSummary.open)
}
#if LANG_CXX11
inline void MarketSummary::set_open(::std::string&& value) {
  ...
  open_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.MarketSummary.open)
}
#endif
inline void MarketSummary::set_open(const char* value) {
  ...
  open_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.MarketSummary.open)
}
inline void MarketSummary::set_open(const char* value, size_t size) {
  
  open_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.MarketSummary.open)
}
inline ::std::string* MarketSummary::mutable_open() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.MarketSummary.open)
  return open_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* MarketSummary::release_open() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.MarketSummary.open)
...
inline void MarketSummary::set_allocated_open(::std::string* open) {
  ...
  open_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), open);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.MarketSummary.open)
}
...
inline const ::std::string& MarketSummary::close() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.MarketSummary.close)
  return close_.GetNoArena();
}
inline void MarketSummary::set_close(const ::std::string& value) {
  
  close_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.MarketSummary.close)
}
#if LANG_CXX11
inline void MarketSummary::set_close(::std::string&& value) {
  ...
  close_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.MarketSummary.close)
}
#endif
inline void MarketSummary::set_close(const char* value) {
  ...
  close_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.MarketSummary.close)
}
inline void MarketSummary::set_close(const char* value, size_t size) {
  
  close_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.MarketSummary.close)
}
inline ::std::string* MarketSummary::mutable_close() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.MarketSummary.close)
  return close_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* MarketSummary::release_close() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.MarketSummary.close)
...
inline void MarketSummary::set_allocated_close(::std::string* close) {
  ...
  close_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), close);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.MarketSummary.close)
}
...
inline const ::std::string& MarketSummary::low() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.MarketSummary.low)
  return low_.GetNoArena();
}
inline void MarketSummary::set_low(const ::std::string& value) {
  
  low_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.MarketSummary.low)
}
#if LANG_CXX11
inline void MarketSummary::set_low(::std::string&& value) {
  ...
  low_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.MarketSummary.low)
}
#endif
inline void MarketSummary::set_low(const char* value) {
  ...
  low_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.MarketSummary.low)
}
inline void MarketSummary::set_low(const char* value, size_t size) {
  
  low_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.MarketSummary.low)
}
inline ::std::string* MarketSummary::mutable_low() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.MarketSummary.low)
  return low_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* MarketSummary::release_low() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.MarketSummary.low)
...
inline void MarketSummary::set_allocated_low(::std::string* low) {
  ...
  low_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), low);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.MarketSummary.low)
}
...
inline const ::std::string& MarketSummary::high() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.MarketSummary.high)
  return high_.GetNoArena();
}
inline void MarketSummary::set_high(const ::std::string& value) {
  
  high_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.MarketSummary.high)
}
#if LANG_CXX11
inline void MarketSummary::set_high(::std::string&& value) {
  ...
  high_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.MarketSummary.high)
}
#endif
inline void MarketSummary::set_high(const char* value) {
  ...
  high_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.MarketSummary.high)
}
inline void MarketSummary::set_high(const char* value, size_t size) {
  
  high_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.MarketSummary.high)
}
inline ::std::string* MarketSummary::mutable_high() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.MarketSummary.high)
  return high_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* MarketSummary::release_high() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.MarketSummary.high)
...
inline void MarketSummary::set_allocated_high(::std::string* high) {
  ...
  high_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), high);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.MarketSummary.high)
}
...
inline const ::std::string& MarketSummary::turnover() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.MarketSummary.turnover)
  return turnover_.GetNoArena();
}
inline void MarketSummary::set_turnover(const ::std::string& value) {
  
  turnover_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.MarketSummary.turnover)
}
#if LANG_CXX11
inline void MarketSummary::set_turnover(::std::string&& value) {
  ...
  turnover_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.MarketSummary.turnover)
}
#endif
inline void MarketSummary::set_turnover(const char* value) {
  ...
  turnover_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.MarketSummary.turnover)
}
inline void MarketSummary::set_turnover(const char* value, size_t size) {
  
  turnover_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.MarketSummary.turnover)
}
inline ::std::string* MarketSummary::mutable_turnover() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.MarketSummary.turnover)
  return turnover_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* MarketSummary::release_turnover() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.MarketSummary.turnover)
...
inline void MarketSummary::set_allocated_turnover(::std::string* turnover) {
  ...
  turnover_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), turnover);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.MarketSummary.turnover)
}
...
inline const ::std::string& MarketSummary::volume() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.MarketSummary.volume)
  return volume_.GetNoArena();
}
inline void MarketSummary::set_volume(const ::std::string& value) {
  
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.MarketSummary.volume)
}
#if LANG_CXX11
inline void MarketSummary::set_volume(::std::string&& value) {
  ...
  volume_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.MarketSummary.volume)
}
#endif
inline void MarketSummary::set_volume(const char* value) {
  ...
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.MarketSummary.volume)
}
inline void MarketSummary::set_volume(const char* value, size_t size) {
  
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.MarketSummary.volume)
}
inline ::std::string* MarketSummary::mutable_volume() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.MarketSummary.volume)
  return volume_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* MarketSummary::release_volume() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.MarketSummary.volume)
...
inline void MarketSummary::set_allocated_volume(::std::string* volume) {
  ...
  volume_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), volume);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.MarketSummary.volume)
}
...
inline ::google::protobuf::int32 MarketSummary::num_of_trades() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.MarketSummary.num_of_trades)
  return num_of_trades_;
}
inline void MarketSummary::set_num_of_trades(::google::protobuf::int32 value) {
  
  num_of_trades_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.MarketSummary.num_of_trades)
}
...
inline const ::std::string& Overview_Tick::symbol() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Overview.Tick.symbol)
  return symbol_.GetNoArena();
}
inline void Overview_Tick::set_symbol(const ::std::string& value) {
  
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Overview.Tick.symbol)
}
#if LANG_CXX11
inline void Overview_Tick::set_symbol(::std::string&& value) {
  ...
  symbol_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Overview.Tick.symbol)
}
#endif
inline void Overview_Tick::set_symbol(const char* value) {
  ...
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Overview.Tick.symbol)
}
inline void Overview_Tick::set_symbol(const char* value, size_t size) {
  
  symbol_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Overview.Tick.symbol)
}
inline ::std::string* Overview_Tick::mutable_symbol() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Overview.Tick.symbol)
  return symbol_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Overview_Tick::release_symbol() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Overview.Tick.symbol)
...
inline void Overview_Tick::set_allocated_symbol(::std::string* symbol) {
  ...
  symbol_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), symbol);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Overview.Tick.symbol)
}
...
inline const ::std::string& Overview_Tick::open() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Overview.Tick.open)
  return open_.GetNoArena();
}
inline void Overview_Tick::set_open(const ::std::string& value) {
  
  open_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Overview.Tick.open)
}
#if LANG_CXX11
inline void Overview_Tick::set_open(::std::string&& value) {
  ...
  open_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Overview.Tick.open)
}
#endif
inline void Overview_Tick::set_open(const char* value) {
  ...
  open_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Overview.Tick.open)
}
inline void Overview_Tick::set_open(const char* value, size_t size) {
  
  open_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Overview.Tick.open)
}
inline ::std::string* Overview_Tick::mutable_open() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Overview.Tick.open)
  return open_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Overview_Tick::release_open() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Overview.Tick.open)
...
inline void Overview_Tick::set_allocated_open(::std::string* open) {
  ...
  open_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), open);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Overview.Tick.open)
}
...
inline const ::std::string& Overview_Tick::close() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Overview.Tick.close)
  return close_.GetNoArena();
}
inline void Overview_Tick::set_close(const ::std::string& value) {
  
  close_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Overview.Tick.close)
}
#if LANG_CXX11
inline void Overview_Tick::set_close(::std::string&& value) {
  ...
  close_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Overview.Tick.close)
}
#endif
inline void Overview_Tick::set_close(const char* value) {
  ...
  close_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Overview.Tick.close)
}
inline void Overview_Tick::set_close(const char* value, size_t size) {
  
  close_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Overview.Tick.close)
}
inline ::std::string* Overview_Tick::mutable_close() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Overview.Tick.close)
  return close_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Overview_Tick::release_close() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Overview.Tick.close)
...
inline void Overview_Tick::set_allocated_close(::std::string* close) {
  ...
  close_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), close);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Overview.Tick.close)
}
...
inline const ::std::string& Overview_Tick::low() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Overview.Tick.low)
  return low_.GetNoArena();
}
inline void Overview_Tick::set_low(const ::std::string& value) {
  
  low_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Overview.Tick.low)
}
#if LANG_CXX11
inline void Overview_Tick::set_low(::std::string&& value) {
  ...
  low_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Overview.Tick.low)
}
#endif
inline void Overview_Tick::set_low(const char* value) {
  ...
  low_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Overview.Tick.low)
}
inline void Overview_Tick::set_low(const char* value, size_t size) {
  
  low_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Overview.Tick.low)
}
inline ::std::string* Overview_Tick::mutable_low() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Overview.Tick.low)
  return low_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Overview_Tick::release_low() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Overview.Tick.low)
...
inline void Overview_Tick::set_allocated_low(::std::string* low) {
  ...
  low_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), low);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Overview.Tick.low)
}
...
inline const ::std::string& Overview_Tick::high() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Overview.Tick.high)
  return high_.GetNoArena();
}
inline void Overview_Tick::set_high(const ::std::string& value) {
  
  high_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Overview.Tick.high)
}
#if LANG_CXX11
inline void Overview_Tick::set_high(::std::string&& value) {
  ...
  high_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Overview.Tick.high)
}
#endif
inline void Overview_Tick::set_high(const char* value) {
  ...
  high_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Overview.Tick.high)
}
inline void Overview_Tick::set_high(const char* value, size_t size) {
  
  high_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Overview.Tick.high)
}
inline ::std::string* Overview_Tick::mutable_high() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Overview.Tick.high)
  return high_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Overview_Tick::release_high() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Overview.Tick.high)
...
inline void Overview_Tick::set_allocated_high(::std::string* high) {
  ...
  high_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), high);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Overview.Tick.high)
}
...
inline const ::std::string& Overview_Tick::turnover() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Overview.Tick.turnover)
  return turnover_.GetNoArena();
}
inline void Overview_Tick::set_turnover(const ::std::string& value) {
  
  turnover_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Overview.Tick.turnover)
}
#if LANG_CXX11
inline void Overview_Tick::set_turnover(::std::string&& value) {
  ...
  turnover_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Overview.Tick.turnover)
}
#endif
inline void Overview_Tick::set_turnover(const char* value) {
  ...
  turnover_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Overview.Tick.turnover)
}
inline void Overview_Tick::set_turnover(const char* value, size_t size) {
  
  turnover_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Overview.Tick.turnover)
}
inline ::std::string* Overview_Tick::mutable_turnover() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Overview.Tick.turnover)
  return turnover_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Overview_Tick::release_turnover() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Overview.Tick.turnover)
...
inline void Overview_Tick::set_allocated_turnover(::std::string* turnover) {
  ...
  turnover_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), turnover);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Overview.Tick.turnover)
}
...
inline const ::std::string& Overview_Tick::volume() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Overview.Tick.volume)
  return volume_.GetNoArena();
}
inline void Overview_Tick::set_volume(const ::std::string& value) {
  
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Overview.Tick.volume)
}
#if LANG_CXX11
inline void Overview_Tick::set_volume(::std::string&& value) {
  ...
  volume_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Overview.Tick.volume)
}
#endif
inline void Overview_Tick::set_volume(const char* value) {
  ...
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Overview.Tick.volume)
}
inline void Overview_Tick::set_volume(const char* value, size_t size) {
  
  volume_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Overview.Tick.volume)
}
inline ::std::string* Overview_Tick::mutable_volume() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Overview.Tick.volume)
  return volume_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Overview_Tick::release_volume() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Overview.Tick.volume)
...
inline void Overview_Tick::set_allocated_volume(::std::string* volume) {
  ...
  volume_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), volume);
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Overview.Tick.volume)
}
...
inline ::google::protobuf::int32 Overview_Tick::num_of_trades() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Overview.Tick.num_of_trades)
  return num_of_trades_;
}
inline void Overview_Tick::set_num_of_trades(::google::protobuf::int32 value) {
  
  num_of_trades_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Overview.Tick.num_of_trades)
}
...
inline ::google::protobuf::int64 Overview::ts() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Overview.ts)
  return ts_;
}
inline void Overview::set_ts(::google::protobuf::int64 value) {
  
  ts_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Overview.ts)
}
...
inline ::com::huobi::gateway::Overview_Tick* Overview::mutable_tick(int index) {
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Overview.tick)
  return tick_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::Overview_Tick >*
Overview::mutable_tick() {
  // @@protoc_insertion_point(field_mutable_list:com.huobi.gateway.Overview.tick)
  return &tick_;
}
inline const ::com::huobi::gateway::Overview_Tick& Overview::tick(int index) const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Overview.tick)
  return tick_.Get(index);
}
inline ::com::huobi::gateway::Overview_Tick* Overview::add_tick() {
  // @@protoc_insertion_point(field_add:com.huobi.gateway.Overview.tick)
  return tick_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::com::huobi::gateway::Overview_Tick >&
Overview::tick() const {
  // @@protoc_insertion_point(field_list:com.huobi.gateway.Overview.tick)
  return tick_;
}
...
inline ::google::protobuf::int64 Ping::ts() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Ping.ts)
  return ts_;
}
inline void Ping::set_ts(::google::protobuf::int64 value) {
  
  ts_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Ping.ts)
}
...
inline ::google::protobuf::int32 Result::code() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Result.code)
  return code_;
}
inline void Result::set_code(::google::protobuf::int32 value) {
  
  code_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Result.code)
}
...
inline ::google::protobuf::int64 Result::sequence() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Result.sequence)
  return sequence_;
}
inline void Result::set_sequence(::google::protobuf::int64 value) {
  
  sequence_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Result.sequence)
}
...
inline ::com::huobi::gateway::Action Result::action() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Result.action)
  return static_cast< ::com::huobi::gateway::Action >(action_);
}
inline void Result::set_action(::com::huobi::gateway::Action value) {
  
  action_ = value;
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Result.action)
}
...
inline const ::std::string& Result::ch() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Result.ch)
...
inline void Result::set_ch(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Result.ch)
}
#if LANG_CXX11
inline void Result::set_ch(::std::string&& value) {
  ...
  ch_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Result.ch)
}
#endif
inline void Result::set_ch(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Result.ch)
}
inline void Result::set_ch(const char* value, size_t size) {
  ...
  ch_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Result.ch)
}
inline ::std::string* Result::mutable_ch() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Result.ch)
  return ch_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Result::release_ch() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Result.ch)
...
inline void Result::set_allocated_ch(::std::string* ch) {
  ...
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Result.ch)
}
...
inline const ::std::string& Result::message() const {
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Result.message)
  return message_.GetNoArena();
}
inline void Result::set_message(const ::std::string& value) {
  
  message_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:com.huobi.gateway.Result.message)
}
#if LANG_CXX11
inline void Result::set_message(::std::string&& value) {
  ...
  message_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:com.huobi.gateway.Result.message)
}
#endif
inline void Result::set_message(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:com.huobi.gateway.Result.message)
}
inline void Result::set_message(const char* value, size_t size) {
  
  message_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:com.huobi.gateway.Result.message)
}
inline ::std::string* Result::mutable_message() {
  
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Result.message)
  return message_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Result::release_message() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Result.message)
...
inline void Result::set_allocated_message(::std::string* message) {
  ...
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Result.message)
}
...
inline const ::google::protobuf::Any& Result::data() const {
  ...
  // @@protoc_insertion_point(field_get:com.huobi.gateway.Result.data)
  return p != NULL ? *p : *reinterpret_cast<const ::google::protobuf::Any*>(
      &::google::protobuf::_Any_default_instance_);
}
inline ::google::protobuf::Any* Result::release_data() {
  // @@protoc_insertion_point(field_release:com.huobi.gateway.Result.data)
...
inline ::google::protobuf::Any* Result::mutable_data() {
  ...
  // @@protoc_insertion_point(field_mutable:com.huobi.gateway.Result.data)
  return data_;
}
inline void Result::set_allocated_data(::google::protobuf::Any* data) {
  ...
  data_ = data;
  // @@protoc_insertion_point(field_set_allocated:com.huobi.gateway.Result.data)
}
...
template <> struct is_proto_enum< ::com::huobi::gateway::Depth_Step> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::huobi::gateway::Depth_Step>() {
  return ::com::huobi::gateway::Depth_Step_descriptor();
}
template <> struct is_proto_enum< ::com::huobi::gateway::Interval> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::huobi::gateway::Interval>() {
  return ::com::huobi::gateway::Interval_descriptor();
}
template <> struct is_proto_enum< ::com::huobi::gateway::Side> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::huobi::gateway::Side>() {
  return ::com::huobi::gateway::Side_descriptor();
}
template <> struct is_proto_enum< ::com::huobi::gateway::Action> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::com::huobi::gateway::Action>() {
  return ::com::huobi::gateway::Action_descriptor();
}
...
#endif  // PROTOBUF_INCLUDED_huobi_5fgateway_5fmarket_5fdownstream_5fprotocol_2eproto
